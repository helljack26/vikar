...
<?php
    $get_sub_product_row=mysqli_query($con,"SELECT * from product_sub_category where category_id='$cat' and subcategoryid='$cid' and product_category_id='$product_cat' and sub_product_category_id='$sub_product' ");
        ...
        <div class="product_category_row">
            ...
            <div class="product_category_row_results">
                ...
                <div class="product_category_row_results_block">
                    <?php
			            $ret=mysqli_query($con,"SELECT * from products where category='$cat' and sub_сategory='$cid' and product_category='$product_cat' and product_sub_category='$sub_product' and organization='Вікар' ORDER BY product_availability DESC");
